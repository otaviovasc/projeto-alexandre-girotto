...
class IcalReservationImporterTest < ActiveSupport::TestCase
  ...
  test "cancels an existing reservation created from known Holmy phantom uid" do
    user = User.create!(
      name: "Holmy",
      email: "holmy-existing@example.com",
      password: "password",
    ...
    reserva = @cabana.reservas.create!(
      ...
      total_price: 0,
      ical_uid: "b0ba833f6f6ecad658415bbd6e3489f544ede966@www.holmy.com.br",
      platform_uid: "b0ba833f6f6ecad658415bbd6e3489f544ede966@www.holmy.com.br",
